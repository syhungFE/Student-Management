...
const dashboardSlice = createSlice({
    ...
    reducers: {
        ...
        setGenderbyCityList(state, action: PayloadAction<GenderbyCity[]>){
            state.genderbyCityList = action.payload
        }
    }
})
...
export const selectGenderbyCityList = (state: RootState) => state.dashboard.genderbyCityList;
